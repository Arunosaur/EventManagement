...
is
   ...
   /*
      ...
      */
    is
      l_c_module constant typ.t_maxfqnm := 'MANAGER_PK.get';
   ...
   */
   is
      l_c_module constant typ.t_maxfqnm := 'MANAGER_PK.add';
   ...
   */
   is
      l_c_module constant typ.t_maxfqnm := 'MANAGER_PK.modify';
   ...
   */
   is
      l_c_module constant typ.t_maxfqnm := 'MANAGER_PK.remove';
