...
(id            number(4) not null constraint pk_classifications primary key,
 code          varchar2(4) not null,
 application_id number(5) null,
 user_id      varchar2(128) not null,
 create_date  date default current_date not null,
 constraint fk_classifications_applications foreign key (application_id) references applications (id)
);

create table classification_logs
(id number(4) not null,
 create_ts         timestamp(6) default current_timestamp not null,
 application_id    number(5) null,
 user_id           varchar2(128) not null,
 constraint pk_classification_logs primary key (id, create_ts),
 constraint fk_classification_logs_classifications foreign key (id) references classifications (id),
 constraint fk_classification_logs_applications foreign key (application_id) references applications (id)
);
...
(id   NUMBER(38,0) not null constraint pk_event_definitions primary key,
 ...
 user_id varchar2(128) not null,
 last_change_date  date default current_date not null,
 constraint fk_event_definitions_classifications foreign key (class_id) references classifications (id)
);
