...
(id  NUMBER(38,0) not null constraint pk_groups primary key,
 ...
 constraint fk_groups_classifications foreign key (class_id) references classifications(id)
);
...
(id   NUMBER(38,0) not null constraint pk_event_definitions primary key,
 ...
 user_id varchar2(128) not null,
 last_change_date  date default current_date not null,
 constraint fk_event_definitions_applications foreign key (application_id) references applications (id)
);
